...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-qorvp3m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-qorvp3m.containers.anotherwebservice.com/
...
```
git clone git@github.com:alexuser223/container-qorvp3m.git
cd container-qorvp3m
```
...
```
docker attach container-qorvp3m
```
